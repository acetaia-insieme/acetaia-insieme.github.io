...
```{=html}
<p class="values-note"><span class="l" lang="it"><strong>I valori riportati su ogni botte</strong> — densità in °Brix e acidità totale in % — si riferiscono all'ultimo controllo, del <strong>14 marzo 2026</strong>. L'andamento nel tempo è nella scheda <em>Misure e grafici</em>.</span><span class="l" lang="en"><strong>The values shown on each barrel</strong> — density in °Brix and total acidity in % — refer to the latest check, of <strong>14 March 2026</strong>. The evolution over time is in the <em>Measurements and charts</em> tab.</span><span class="l" lang="de"><strong>Die auf jedem Fass angegebenen Werte</strong> — Dichte in °Brix und Gesamtsäure in % — beziehen sich auf die letzte Kontrolle vom <strong>14. März 2026</strong>. Den Verlauf über die Zeit zeigt der Reiter <em>Messungen und Grafiken</em>.</span><span class="l" lang="es"><strong>Los valores indicados en cada barril</strong> — densidad en °Brix y acidez total en % — se refieren al último control, del <strong>14 de marzo de 2026</strong>. La evolución en el tiempo está en la pestaña <em>Medidas y gráficos</em>.</span><span class="l" lang="fr"><strong>Les valeurs indiquées sur chaque fût</strong> — densité en °Brix et acidité totale en % — se réfèrent au dernier contrôle, du <strong>14 mars 2026</strong>. L'évolution dans le temps se trouve dans l'onglet <em>Mesures et graphiques</em>.</span><span class="l" lang="pt"><strong>Os valores indicados em cada barril</strong> — densidade em °Brix e acidez total em % — referem-se ao último controle, de <strong>14 de março de 2026</strong>. A evolução no tempo está na aba <em>Medições e gráficos</em>.</span></p>
```
