...
```{=html}
<div id="batterie" class="tab-anchor"></div>
```

::: {.l lang=it}
L'Acetaia Insieme è composta da tre batterie, A, B e C, acquisite nel 2024 e seguite con misure regolari di acidità e densità. Le botti sono numerate dalla più piccola alla più grande (A1 è la botte da 15 litri, A5 quella da 50). Qui trovate i [parametri di ogni batteria](#batterie), i [legni](imparare.qmd#legni), i [volumi stimati](#volume-botti), le [condizioni all'interno dell'acetaia](#temperatura-umidita) e la [cronologia dei lavori](#cronologia).
:::

::: {.l lang=en}
Acetaia Insieme consists of three batteries, A, B and C, acquired in 2024 and followed with regular measurements of acidity and density. Barrels are numbered from the smallest to the largest (A1 is the 15-litre barrel, A5 the 50-litre one). Here you find the [parameters of each battery](#batterie), the [woods](imparare.qmd#legni), the [estimated volumes](#volume-botti), the [conditions inside the acetaia](#temperatura-umidita) and the [timeline of the work](#cronologia).
:::

::: {.l lang=de}
Die Acetaia Insieme besteht aus drei Batterien, A, B und C, die 2024 erworben wurden und regelmäßig auf Säure und Dichte gemessen werden. Die Fässer sind vom kleinsten zum größten nummeriert (A1 ist das 15-Liter-Fass, A5 das 50-Liter-Fass). Hier findet ihr die [Parameter jeder Batterie](#batterie), die [Hölzer](imparare.qmd#legni), die [geschätzten Volumen](#volume-botti), die [Bedingungen im Inneren der Acetaia](#temperatura-umidita) und die [Chronik der Arbeiten](#cronologia).
:::
::: {.l lang=es}
La Acetaia Insieme está compuesta por tres baterías, A, B y C, adquiridas en 2024 y seguidas con medidas regulares de acidez y densidad. Los barriles están numerados del más pequeño al más grande (A1 es el barril de 15 litros, A5 el de 50). Aquí encontraréis los [parámetros de cada batería](#batterie), las [maderas](imparare.qmd#legni), los [volúmenes estimados](#volume-botti), las [condiciones en el interior de la acetaia](#temperatura-umidita) y la [cronología de los trabajos](#cronologia).
:::
::: {.l lang=fr}
L'Acetaia Insieme se compose de trois batteries, A, B et C, acquises en 2024 et suivies par des mesures régulières d'acidité et de densité. Les fûts sont numérotés du plus petit au plus grand (A1 est le fût de 15 litres, A5 celui de 50). Vous trouverez ici les [paramètres de chaque batterie](#batterie), les [bois](imparare.qmd#legni), les [volumes estimés](#volume-botti), les [conditions à l'intérieur de l'acetaia](#temperatura-umidita) et la [chronologie des travaux](#cronologia).
:::
::: {.l lang=pt}
A Acetaia Insieme é composta por três baterias, A, B e C, adquiridas em 2024 e acompanhadas com medições regulares de acidez e densidade. Os barris são numerados do menor ao maior (A1 é o barril de 15 litros, A5 o de 50). Aqui vocês encontram os [parâmetros de cada bateria](#batterie), as [madeiras](imparare.qmd#legni), os [volumes estimados](#volume-botti), as [condições no interior da acetaia](#temperatura-umidita) e a [cronologia dos trabalhos](#cronologia).
:::

```{=html}
<figure class="batterie-foto">
  <img src="foto/batterie_1.jpg" alt="Le tre batterie dell'Acetaia Insieme nel fienile">
  <figcaption><span class="l" lang="it">Le tre batterie nel fienile: sedici botti in tutto, dalla più piccola da 15 litri alla più grande da 60.</span><span class="l" lang="en">The three batteries in the hayloft: sixteen barrels in all, from the smallest at 15 litres to the largest at 60.</span><span class="l" lang="de">Die drei Batterien in der Scheune: insgesamt sechzehn Fässer, vom kleinsten mit 15 Litern bis zum größten mit 60.</span><span class="l" lang="es">Las tres baterías en el pajar: dieciséis barriles en total, desde el más pequeño de 15 litros hasta el más grande de 60.</span><span class="l" lang="fr">Les trois batteries dans la grange : seize fûts en tout, du plus petit de 15 litres au plus grand de 60.</span><span class="l" lang="pt">As três baterias no celeiro: dezesseis barris ao todo, do menor de 15 litros ao maior de 60.</span></figcaption>
</figure>
```

```{=html}
<p class="values-note"><span class="l" lang="it"><strong>I valori riportati su ogni botte</strong> — densità in °Brix e acidità totale in % — si riferiscono all'ultimo controllo, del <strong>14 marzo 2026</strong>. L'andamento nel tempo è nella scheda <a href="#misure-grafici">Misure e grafici</a>.</span><span class="l" lang="en"><strong>The values shown on each barrel</strong> — density in °Brix and total acidity in % — refer to the latest check, of <strong>14 March 2026</strong>. The evolution over time is in the <a href="#misure-grafici">Measurements and charts</a> tab.</span><span class="l" lang="de"><strong>Die auf jedem Fass angegebenen Werte</strong> — Dichte in °Brix und Gesamtsäure in % — beziehen sich auf die letzte Kontrolle vom <strong>14. März 2026</strong>. Den Verlauf über die Zeit zeigt der Reiter <a href="#misure-grafici">Messungen und Grafiken</a>.</span><span class="l" lang="es"><strong>Los valores indicados en cada barril</strong> — densidad en °Brix y acidez total en % — se refieren al último control, del <strong>14 de marzo de 2026</strong>. La evolución en el tiempo está en la pestaña <a href="#misure-grafici">Medidas y gráficos</a>.</span><span class="l" lang="fr"><strong>Les valeurs indiquées sur chaque fût</strong> — densité en °Brix et acidité totale en % — se réfèrent au dernier contrôle, du <strong>14 mars 2026</strong>. L'évolution dans le temps se trouve dans l'onglet <a href="#misure-grafici">Mesures et graphiques</a>.</span><span class="l" lang="pt"><strong>Os valores indicados em cada barril</strong> — densidade em °Brix e acidez total em % — referem-se ao último controle, de <strong>14 de março de 2026</strong>. A evolução no tempo está na aba <a href="#misure-grafici">Medições e gráficos</a>.</span></p>
```
...
```{=html}
<div id="misure-grafici" class="tab-anchor"></div>
```
...
**Acidità totale, in % (grammi di acido acetico per 100 ml).** La misuriamo per titolazione: a 1 ml di aceto diluito in acqua distillata aggiungiamo poche gocce di fenolftaleina e poi soda (NaOH 0,1 N) goccia a goccia finché la soluzione vira al rosa; i millilitri di soda usati, moltiplicati per 0,6, danno la percentuale di acidità. Il procedimento passo per passo è nella scheda [La titolazione](imparare.qmd#titolazione). Un'acidità sempre sopra il 3 % protegge dalle muffe; nelle botti si assesta col tempo, mentre la parte volatile evapora.

Alcune misure sono analisi di laboratorio, le altre le facciamo in casa. Ultimo controllo: 14 marzo 2026.
:::
::: {.l lang=en}
...
**Gesamtsäure, in % (Gramm Essigsäure pro 100 ml).** Wir messen sie durch Titration: zu 1 ml Essig, verdünnt in destilliertem Wasser, geben wir einige Tropfen Phenolphthalein und dann tropfenweise Natronlauge (NaOH 0,1 N), bis die Lösung rosa wird; die verbrauchten Milliliter NaOH mal 0,6 ergeben den Säuregehalt in Prozent. Die Schritt-für-Schritt-Anleitung steht im Reiter [Die Titration](imparare.qmd#titolazione). Eine Säure stets über 3 % schützt vor Schimmel; in den Fässern pendelt sie sich mit der Zeit ein, während der flüchtige Teil verdunstet.

Ein Teil der Messungen sind Laboranalysen, die übrigen machen wir zu Hause. Letzte Kontrolle: 14. März 2026.
:::
::: {.l lang=es}
...
**Acidez total, en % (gramos de ácido acético por 100 ml).** La medimos por titulación: a 1 ml de vinagre diluido en agua destilada le añadimos unas gotas de fenolftaleína y después sosa (NaOH 0,1 N) gota a gota hasta que la solución vira a rosa; los mililitros de sosa empleados, multiplicados por 0,6, dan el porcentaje de acidez. El procedimiento paso a paso está en la pestaña [La titulación](imparare.qmd#titolazione). Una acidez siempre por encima del 3 % protege de los mohos; en los barriles se estabiliza con el tiempo, mientras la parte volátil se evapora.

Algunas medidas son análisis de laboratorio, las demás las hacemos en casa. Último control: 14 de marzo de 2026.
:::
::: {.l lang=fr}
...
**Acidité totale, en % (grammes d'acide acétique pour 100 ml).** Nous la mesurons par titrage : à 1 ml de vinaigre dilué dans de l'eau distillée, nous ajoutons quelques gouttes de phénolphtaléine, puis de la soude (NaOH 0,1 N) goutte à goutte jusqu'à ce que la solution vire au rose ; les millilitres de soude utilisés, multipliés par 0,6, donnent le pourcentage d'acidité. La procédure pas à pas est dans l'onglet [Le titrage](imparare.qmd#titolazione). Une acidité toujours supérieure à 3 % protège des moisissures ; dans les fûts, elle se stabilise avec le temps, tandis que la partie volatile s'évapore.

Certaines mesures sont des analyses de laboratoire, les autres, nous les faisons à la maison. Dernier contrôle : 14 mars 2026.
:::
::: {.l lang=pt}
...
**Acidez total, em % (gramas de ácido acético por 100 ml).** Nós a medimos por titulação: a 1 ml de vinagre diluído em água destilada acrescentamos algumas gotas de fenolftaleína e depois soda (NaOH 0,1 N) gota a gota até a solução virar para o rosa; os mililitros de soda usados, multiplicados por 0,6, dão a porcentagem de acidez. O procedimento passo a passo está na aba [A titulação](imparare.qmd#titolazione). Uma acidez sempre acima de 3 % protege contra os mofos; nos barris ela se estabiliza com o tempo, enquanto a parte volátil evapora.

Algumas medições são análises de laboratório, as outras fazemos em casa. Último controle: 14 de março de 2026.
:::
...
<p><small><span class="l" lang="it">Licenza: dati liberamente riutilizzabili citando "Acetaia Insieme, Cavezzo". Suggerimenti e correzioni: scrivete a Leonardo Capitani, <a href="mailto:leocapi07@gmail.com">leocapi07@gmail.com</a>.</span><span class="l" lang="en">Licence: data freely reusable citing "Acetaia Insieme, Cavezzo". Suggestions and corrections: write to Leonardo Capitani, <a href="mailto:leocapi07@gmail.com">leocapi07@gmail.com</a>.</span><span class="l" lang="de">Lizenz: Daten frei nutzbar unter Angabe von „Acetaia Insieme, Cavezzo". Vorschläge und Korrekturen: schreibt an Leonardo Capitani, <a href="mailto:leocapi07@gmail.com">leocapi07@gmail.com</a>.</span><span class="l" lang="es">Licencia: datos libremente reutilizables citando "Acetaia Insieme, Cavezzo". Sugerencias y correcciones: escribid a Leonardo Capitani, <a href="mailto:leocapi07@gmail.com">leocapi07@gmail.com</a>.</span><span class="l" lang="fr">Licence : données librement réutilisables en citant « Acetaia Insieme, Cavezzo ». Suggestions et corrections : écrivez à Leonardo Capitani, <a href="mailto:leocapi07@gmail.com">leocapi07@gmail.com</a>.</span><span class="l" lang="pt">Licença: dados livremente reutilizáveis citando "Acetaia Insieme, Cavezzo". Sugestões e correções: escrevam para Leonardo Capitani, <a href="mailto:leocapi07@gmail.com">leocapi07@gmail.com</a>.</span></small></p>
```
...
```{=html}
<div id="volume-botti" class="tab-anchor"></div>
```
...
```{=html}
<div id="temperatura-umidita" class="tab-anchor"></div>
```
...
```{=html}
<div id="cronologia" class="tab-anchor"></div>
```
...
<ul class="timeline">
  ...
  <li><time>24/04/2024</time><span class="l" lang="it">Innesto delle batterie con mosto cotto acetificato: 26,5 °Brix, acidità 8 %.</span><span class="l" lang="en">The batteries are started with acetified cooked must: 26.5 °Brix, acidity 8 %.</span><span class="l" lang="de">Die Batterien werden mit essigsauer vergorenem gekochtem Most angesetzt: 26,5 °Brix, Säure 8 %.</span><span class="l" lang="es">Injerto de las baterías con mosto cocido acetificado: 26,5 °Brix, acidez 8 %.</span><span class="l" lang="fr">Ensemencement des batteries avec du moût cuit acétifié : 26,5 °Brix, acidité 8 %.</span><span class="l" lang="pt">Inoculação das baterias com mosto cozido acetificado: 26,5 °Brix, acidez 8 %.</span></li>
  <li><time>21/09/2024</time><span class="l" lang="it">Prime analisi di laboratorio sulla batteria B.</span><span class="l" lang="en">First laboratory analyses on battery B.</span><span class="l" lang="de">Erste Laboranalysen an Batterie B.</span><span class="l" lang="es">Primeros análisis de laboratorio en la batería B.</span><span class="l" lang="fr">Premières analyses de laboratoire sur la batterie B.</span><span class="l" lang="pt">Primeiras análises de laboratório na bateria B.</span></li>
  ...
  <li><time>07/05/2025</time><span class="l" lang="it">Analisi di laboratorio di tutte le botti.</span><span class="l" lang="en">Laboratory analyses of all barrels.</span><span class="l" lang="de">Laboranalysen aller Fässer.</span><span class="l" lang="es">Análisis de laboratorio de todos los barriles.</span><span class="l" lang="fr">Analyses de laboratoire de tous les fûts.</span><span class="l" lang="pt">Análises de laboratório de todos os barris.</span></li>
  <li><time>14/03/2026</time><span class="l" lang="it">Analisi di laboratorio, rilievo dei livelli e delle dimensioni delle botti, calcolo dei volumi.</span><span class="l" lang="en">Laboratory analyses, survey of levels and barrel dimensions, volume calculation.</span><span class="l" lang="de">Laboranalysen, Erfassung der Füllstände und Fassmaße, Volumenberechnung.</span><span class="l" lang="es">Análisis de laboratorio, medición de los niveles y de las dimensiones de los barriles, cálculo de los volúmenes.</span><span class="l" lang="fr">Analyses de laboratoire, relevé des niveaux et des dimensions des fûts, calcul des volumes.</span><span class="l" lang="pt">Análises de laboratório, levantamento dos níveis e das dimensões dos barris, cálculo dos volumes.</span></li>
</ul>
```

## [Premi]{.l lang=it}[Awards]{.l lang=en}[Auszeichnungen]{.l lang=de}[Premios]{.l lang=es}[Prix]{.l lang=fr}[Prêmios]{.l lang=pt}

```{=html}
<div id="premi" class="tab-anchor"></div>
```

::: {.l lang=it}
Al **52° Palio di San Giovanni** di Spilamberto, nel 2018, la **batteria B, barile 1** ha ricevuto una valutazione di **322,125 punti**, classificandosi al **2° posto su 1451 partecipanti** ([vedi i risultati](https://www.consorteria-abtm.it/wp-content/uploads/2020/03/52-PALIO-2018b.pdf)).

A nome dell'Acetaia Insieme ringraziamo il precedente proprietario, **Marco Morandi** di Formigine, che fino al 2024 ha mantenuto la batteria B a questi livelli di eccellenza. Ora tocca a noi l'ardua impresa di mantenere la qualità e produrre un eccellente aceto balsamico.
:::
::: {.l lang=en}
At the **52nd Palio di San Giovanni** in Spilamberto, in 2018, **battery B, barrel 1** was awarded **322.125 points**, taking **2nd place out of 1,451 entries** ([see the results](https://www.consorteria-abtm.it/wp-content/uploads/2020/03/52-PALIO-2018b.pdf)).

On behalf of Acetaia Insieme we thank the previous owner, **Marco Morandi** of Formigine, who kept battery B at this level of excellence until 2024. Now it is up to us to take on the hard task of keeping that quality and producing an excellent balsamic vinegar.
:::
::: {.l lang=de}
Beim **52. Palio di San Giovanni** in Spilamberto erhielt 2018 die **Batterie B, Fass 1** eine Bewertung von **322,125 Punkten** und belegte damit den **2. Platz unter 1451 Teilnehmern** ([Ergebnisse ansehen](https://www.consorteria-abtm.it/wp-content/uploads/2020/03/52-PALIO-2018b.pdf)).

Im Namen der Acetaia Insieme danken wir dem Vorbesitzer, **Marco Morandi** aus Formigine, der die Batterie B bis 2024 auf diesem Niveau gehalten hat. Nun liegt es an uns, die schwierige Aufgabe zu übernehmen, diese Qualität zu bewahren und einen ausgezeichneten Balsamessig zu erzeugen.
:::
::: {.l lang=es}
En el **52.º Palio di San Giovanni** de Spilamberto, en 2018, la **batería B, barril 1** obtuvo una valoración de **322,125 puntos** y se clasificó en **2.º lugar entre 1451 participantes** ([ver los resultados](https://www.consorteria-abtm.it/wp-content/uploads/2020/03/52-PALIO-2018b.pdf)).

En nombre de la Acetaia Insieme damos las gracias al anterior propietario, **Marco Morandi** de Formigine, que hasta 2024 mantuvo la batería B en estos niveles de excelencia. Ahora nos toca a nosotros la ardua tarea de mantener la calidad y producir un excelente vinagre balsámico.
:::
::: {.l lang=fr}
Au **52e Palio di San Giovanni** de Spilamberto, en 2018, la **batterie B, fût 1** a obtenu une note de **322,125 points**, se classant **2e sur 1451 participants** ([voir les résultats](https://www.consorteria-abtm.it/wp-content/uploads/2020/03/52-PALIO-2018b.pdf)).

Au nom de l'Acetaia Insieme, nous remercions le précédent propriétaire, **Marco Morandi** de Formigine, qui a maintenu la batterie B à ce niveau d'excellence jusqu'en 2024. C'est désormais à nous qu'incombe la tâche difficile de préserver cette qualité et de produire un excellent vinaigre balsamique.
:::
::: {.l lang=pt}
No **52.º Palio di San Giovanni** de Spilamberto, em 2018, a **bateria B, barril 1** recebeu uma avaliação de **322,125 pontos**, classificando-se em **2.º lugar entre 1451 participantes** ([ver os resultados](https://www.consorteria-abtm.it/wp-content/uploads/2020/03/52-PALIO-2018b.pdf)).

Em nome da Acetaia Insieme agradecemos ao proprietário anterior, **Marco Morandi** de Formigine, que até 2024 manteve a bateria B nesses níveis de excelência. Agora cabe a nós a árdua missão de manter a qualidade e produzir um excelente vinagre balsâmico.
:::

```{=html}
<p class="values-note"><span class="l" lang="it">Scheda del campione n. 681: acidità/peso 5,594 · 76,94 °Brix · densità 1,404 · acidità/volume 7,854 · indice R 9,796 · <strong>322,125 punti su 400</strong> · "Eccellente finalista", Consorteria dell'Aceto Balsamico Tradizionale di Spilamberto.</span><span class="l" lang="en">Sample no. 681: acidity/weight 5.594 · 76.94 °Brix · density 1.404 · acidity/volume 7.854 · R index 9.796 · <strong>322.125 points out of 400</strong> · "Excellent finalist", Consorteria dell'Aceto Balsamico Tradizionale di Spilamberto.</span><span class="l" lang="de">Probe Nr. 681: Säure/Gewicht 5,594 · 76,94 °Brix · Dichte 1,404 · Säure/Volumen 7,854 · R-Index 9,796 · <strong>322,125 von 400 Punkten</strong> · „Ausgezeichneter Finalist", Consorteria dell'Aceto Balsamico Tradizionale di Spilamberto.</span><span class="l" lang="es">Muestra n.º 681: acidez/peso 5,594 · 76,94 °Brix · densidad 1,404 · acidez/volumen 7,854 · índice R 9,796 · <strong>322,125 puntos sobre 400</strong> · "Excelente finalista", Consorteria dell'Aceto Balsamico Tradizionale di Spilamberto.</span><span class="l" lang="fr">Échantillon n° 681 : acidité/poids 5,594 · 76,94 °Brix · densité 1,404 · acidité/volume 7,854 · indice R 9,796 · <strong>322,125 points sur 400</strong> · « Excellent finaliste », Consorteria dell'Aceto Balsamico Tradizionale di Spilamberto.</span><span class="l" lang="pt">Amostra n.º 681: acidez/peso 5,594 · 76,94 °Brix · densidade 1,404 · acidez/volume 7,854 · índice R 9,796 · <strong>322,125 pontos em 400</strong> · "Excelente finalista", Consorteria dell'Aceto Balsamico Tradizionale di Spilamberto.</span></p>
```

```{=html}
<figure class="verbale"><img src="foto/verbale_palio_2018.jpg" alt="Verbale di notificazione del 52° Palio di San Giovanni, 2018"><figcaption><span class="l" lang="it">Il verbale di notificazione del campione n. 681, 52° Palio di San Giovanni, Spilamberto 2018. L'indirizzo del conferente è oscurato per riservatezza.</span><span class="l" lang="en">The notification record of sample no. 681, 52nd Palio di San Giovanni, Spilamberto 2018. The entrant's street address is blurred for privacy.</span><span class="l" lang="de">Das Protokoll der Probe Nr. 681, 52. Palio di San Giovanni, Spilamberto 2018. Die Anschrift des Einreichers ist aus Datenschutzgründen unkenntlich gemacht.</span><span class="l" lang="es">El acta de notificación de la muestra n.º 681, 52.º Palio di San Giovanni, Spilamberto 2018. La dirección del participante está difuminada por privacidad.</span><span class="l" lang="fr">Le procès-verbal de notification de l'échantillon n° 681, 52e Palio di San Giovanni, Spilamberto 2018. L'adresse du participant est floutée pour des raisons de confidentialité.</span><span class="l" lang="pt">A ata de notificação da amostra n.º 681, 52.º Palio di San Giovanni, Spilamberto 2018. O endereço do participante está desfocado por privacidade.</span></figcaption></figure>
```
...
(function(){
  ...
  function drawClima(){
    if(!clima) return; var l=L[lang()], cfg={responsive:true,displayModeBar:false}, d=dark();
    var tr=[
      {x:clima.date.concat(clima.date.slice().reverse()),y:clima.tmax.concat(clima.tmin.slice().reverse()),fill:'toself',fillcolor:d?'rgba(224,140,80,.22)':'rgba(200,120,60,.20)',line:{width:0},name:l.rng,hoverinfo:'skip',showlegend:true},
      {x:clima.date,y:clima.tmax,name:'T max',mode:'lines',line:{width:0},hovertemplate:'T max %{y:.1f} °C<extra></extra>',showlegend:false},
      {x:clima.date,y:clima.tmin,name:'T min',mode:'lines',line:{width:0},hovertemplate:'T min %{y:.1f} °C<extra></extra>',showlegend:false},
      {x:clima.date,y:clima.t,name:l.tm,mode:'lines',line:{color:d?'#ff7a5c':'#c0392b',width:2.4,shape:'spline',smoothing:0.4},hovertemplate:'<b>%{y:.1f} °C</b><extra></extra>'},
      {x:clima.date,y:clima.rh,name:l.rhm,yaxis:'y2',mode:'lines',line:{color:d?'#6ec6f0':'#2e86ab',width:2,dash:'dot',shape:'spline',smoothing:0.4},hovertemplate:'%{y:.1f} % RH<extra></extra>'}
    ];
    var grid=d?'rgba(255,255,255,.10)':'rgba(0,0,0,.08)';
    var lay=Object.assign(base(),{
      hovermode:'x unified',
      hoverdistance:80,
      hoverlabel:{bgcolor:d?'#2b1f1f':'#ffffff',bordercolor:d?'#c8a15a':'#5a1e26',font:{color:d?'#f4ead9':'#2b2118',size:13,family:'Source Sans 3, sans-serif'},align:'left',namelength:-1},
      xaxis:{title:l.date,showspikes:true,spikemode:'across',spikethickness:1.5,spikedash:'solid',spikecolor:d?'rgba(200,161,90,.9)':'rgba(90,30,38,.55)',gridcolor:grid,hoverformat:'%d %b %Y'},
      yaxis:{title:{text:l.t,font:{color:d?'#ff7a5c':'#c0392b'}},range:[0,36],gridcolor:grid,tickfont:{color:d?'#ff7a5c':'#c0392b'},zeroline:false},
      yaxis2:{title:{text:l.rh,font:{color:d?'#6ec6f0':'#2e86ab'}},overlaying:'y',side:'right',range:[40,100],showgrid:false,tickfont:{color:d?'#6ec6f0':'#2e86ab'}},
      legend:{orientation:'h',y:-0.22,x:0},
      margin:{t:20,r:65,l:58,b:56}});
    Plotly.react('chart-clima',tr,lay,cfg);
  }
